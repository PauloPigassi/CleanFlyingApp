...
public class AssinaturaDoisActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assinatura_dois);
        this.setTitle("ENTRADA - ATENDENTE");
        ...
        Button bt_gravar = (Button) findViewById(R.id.bt_ok_dois);
        bt_gravar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                String nomeArquivo = nrFicha+"dois";
                ...
                String uploadFileName = nrFicha + "dois.png";
                String filename = uploadFilePath + uploadFileName;

                Toast.makeText(AssinaturaDoisActivity.this,"Arquivo:: "+filename, Toast.LENGTH_LONG).show();

                File file = new File(filename);
                if (file.exists() == true)
                {

                    //Toast.makeText(AssinaturaDoisActivity.this,"Arquivo existe: ", Toast.LENGTH_LONG).show();
                    ...
                    //Toast.makeText(AssinaturaDoisActivity.this,"Arquivo não existe: ", Toast.LENGTH_LONG).show();
