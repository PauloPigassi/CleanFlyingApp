...
public class AssinaturaTresActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assinatura_tres);
        this.setTitle("SAÍDA - INSPETOR");
        ...
        Button bt_gravar = (Button) findViewById(R.id.bt_ok_tres);
        bt_gravar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                String nomeArquivo = nrFicha+"tres";
                ...
                String uploadFileName = nrFicha + "tres.png";
                String filename = uploadFilePath + uploadFileName;

                Toast.makeText(AssinaturaTresActivity.this,"Arquivo:: "+filename, Toast.LENGTH_LONG).show();

                File file = new File(filename);
                if (file.exists() == true)
                {

                    //Toast.makeText(AssinaturaTresActivity.this,"Arquivo existe: ", Toast.LENGTH_LONG).show();
                    ...
                    //Toast.makeText(AssinaturaTresActivity.this,"Arquivo não existe: ", Toast.LENGTH_LONG).show();
