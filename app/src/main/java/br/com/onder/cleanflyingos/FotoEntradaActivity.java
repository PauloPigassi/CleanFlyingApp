...
public class FotoEntradaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_foto_entrada);
        this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        this.setTitle("FOTO INICIO");
        ...
        if(imageFile.exists()){
            ImageView imageView= (ImageView) findViewById(R.id.iv_foto_entrada);
