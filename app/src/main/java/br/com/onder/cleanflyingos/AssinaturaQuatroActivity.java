...
public class AssinaturaQuatroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assinatura_quatro);
        this.setTitle("SAÍDA - RESPONSÁVEL PELA AERONAVE");
        ...
        Button bt_gravar = (Button) findViewById(R.id.bt_ok_quatro);
        bt_gravar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                String nomeArquivo = nrFicha+"quatro";
                ...
                String uploadFileName = nrFicha + "quatro.png";
                String filename = uploadFilePath + uploadFileName;

               // Toast.makeText(AssinaturaQuatroActivity.this,"Arquivo:: "+filename, Toast.LENGTH_LONG).show();

                File file = new File(filename);
                if (file.exists() == true)
                {

                    Toast.makeText(AssinaturaQuatroActivity.this,"Arquivo existe: ", Toast.LENGTH_LONG).show();
                   ...
                   // Toast.makeText(AssinaturaQuatroActivity.this,"Arquivo não existe: ", Toast.LENGTH_LONG).show();
